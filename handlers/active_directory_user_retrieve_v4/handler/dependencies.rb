...
if not defined?(Net::LDAP)
  ...
  handler_path = File.expand_path(File.dirname(__FILE__))
  # Calculate the location of our library and add it to the Ruby load path
  library_path = File.join(handler_path, 'vendor/net-ldap-0.12.0/lib')
  $:.unshift library_path
  # Require the library
  require 'net/ldap'
end
...
elsif Net::LDAP::VERSION != '0.12.0'
  raise "Incompatible library version #{Net::LDAP::VERSION} for Net::LDAP.  Expecting version 0.12.0."
end
